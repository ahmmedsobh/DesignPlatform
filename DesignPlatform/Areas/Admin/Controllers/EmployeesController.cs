...
namespace DesignPlatform.Areas.Admin.Controllers
{
    ...
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(ApplicationDbContext context, UserManager<ApplicationUser> userManager, ICurrentUserService currentUserService)
        {
        ...
        public async Task<IActionResult> Index(AdminEmployeeParamsViewModel model)
        {
            ...
            var MainRole = ((int)Roles.ProjectManger).ToString();
        ...
        public async Task<IActionResult> Add(AdminEmployeeAddViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    var RoleResut =  await userManager.AddToRoleAsync(user,Roles.ProjectManger.ToString());
        ...
        public async Task<IActionResult> IsPhoneExists(string Phone)
        {
        ...
        #region Validations
        [AllowAnonymous]
        public async Task<IActionResult> IsEmailExistsById(string Email,string Id)
        {
            var user = await context.Users.FirstOrDefaultAsync(i => i.Email == Email && i.Id != Id);
        ...
        public async Task<IActionResult> IsPhoneExistsById(string Phone, string Id)
        {
            var user = await context.Users.FirstOrDefaultAsync(i => i.PhoneNumber == Phone && i.Id != Id);
